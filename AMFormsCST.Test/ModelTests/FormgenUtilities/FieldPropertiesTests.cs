...
public class FieldPropertiesTests
{
    ...
    public void GetDisplayProperties_ReturnsCorrectProperties()
    {
        ...
        Assert.Contains(displayProperties, dp => dp.Name == "Sample Data:" && dp.Value == "MyData");
        Assert.Contains(displayProperties, dp => dp.Name == "Formatting:" && dp.Value == "NAIfBlank");
        Assert.Contains(displayProperties, dp => dp.Name == "ID:" && dp.Value == "123");
        Assert.Contains(displayProperties, dp => dp.Name == "Type:" && dp.Value == "SIGNATURE");
        Assert.Contains(displayProperties, dp => dp.Name == "Font Size:" && dp.Value == "12");
        Assert.Contains(displayProperties, dp => dp.Name == "Alignment:" && dp.Value == "RIGHT");
        Assert.Contains(displayProperties, dp => dp.Name == "Bold:" && dp.Value == "True");
        Assert.Contains(displayProperties, dp => dp.Name == "Shrink to Fit:" && dp.Value == "False");
    }
}